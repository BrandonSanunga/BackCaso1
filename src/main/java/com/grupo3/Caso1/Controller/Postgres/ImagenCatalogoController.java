...
public class ImagenCatalogoController {
		...
		public BodyBuilder uplaodImage(@RequestParam("imageFile") MultipartFile file) throws IOException {
			...
			ImagenCatalogo img = new ImagenCatalogo(file.getOriginalFilename(), file.getContentType(),
		...
		public ImagenCatalogo getImage(@PathVariable("imageName") String imageName) throws IOException {	
			final Optional<ImagenCatalogo> retrievedImage = imageRepository.findByName(imageName);
			ImagenCatalogo img = new ImagenCatalogo(retrievedImage.get().getName(), retrievedImage.get().getType(),
