...
public class vehiculo_catalogoController {
	...
	public vehiculo_catalogo find(@PathVariable String id_vehiculo_catalogo) {
	...
	public ResponseEntity<vehiculo_catalogo> delete(@PathVariable String id_vehiculo_catalogo){
